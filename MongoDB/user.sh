...
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"nodejs"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"nodejs"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"nodejs#123"}
MONGODB_APPLICATION_COLLECTION=${MONGODB_APPLICATION_COLLECTION:-"users"}
...
db.createUser({user: '$MONGODB_APPLICATION_USER', pwd: '$MONGODB_APPLICATION_PASS', roles:[{role:'readWrite', db:'$MONGODB_APPLICATION_DATABASE'},{role:'dbAdmin', db:'$MONGODB_APPLICATION_DATABASE'}]})
...
echo "=> Importing initial data to $MONGODB_APPLICATION_DATABASE database"
mongoimport --db $MONGODB_APPLICATION_DATABASE --collection $MONGODB_APPLICATION_COLLECTION --file /usr/NodeJS/MongoDB/init.json -u $MONGODB_APPLICATION_USER -p $MONGODB_APPLICATION_PASS
